                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade @include('Error.TabsActive')" id="table" role="tabpanel"
                                ...
                                <div class="table-responsive" style="margin-top: 50px;">
                                    <table id="table-detail" class="table table-lg">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
                                                <th>Kode Detail</th>
                                                    ...
                                                    <div class="col-md-4" style="margin-top: 10px;">
                                                        <fieldset>
                                                            <div class="form-group">
                                                                <label for="kode_detail">Kode Detail</label>
                                                                <input type="text" class="form-control"
                                                                    name="kode_detail" placeholder="Input Here">
                                                                @error('kode_detail')
                                                    ...
                                                    <div class="col-md-4" style="margin-top: 10px;">
                                                        <fieldset>
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="harga_satuan" placeholder="Input Here">
                                                                @error('harga_satuan')
                                                                <p class="text-danger">{{ $message }}</p>
                                                                @enderror
                                                            </div>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#btn-edit', function()
        {
            ...
            $.get(url, function(data){
                    ...
                    <div class="col-md-4" style="margin-top: 10px;">
                        <fieldset>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    name="kode_detail" id="kode_detail" value="`+data.kode_detail+`">
                            </div>
                        </fieldset>
                    </div>
                    <div class="col-md-4" style="margin-top: 10px;">
                    ...
                    <div class="col-md-4" style="margin-top: 10px;">
                        <fieldset>
                            <div class="form-group">
                                <label for="harga_satuan">Harga Satuan</label>
                                <input type="text" class="form-control"
                                    name="harga_satuan" id="harga_satuan" value="`+data.harga_satuan+`">
                            </div>
                        </fieldset>
                    </div>
                </div>
                ...
                $('#form-edit').attr('action',`{{route('detail.update')}}`);
            });
        });

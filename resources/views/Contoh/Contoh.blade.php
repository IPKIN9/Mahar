                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade @include('Error.TabsActive')" id="table" role="tabpanel"
                                ...
                                <div class="table-responsive" style="margin-top: 50px;">
                                    <table id="table-contoh" class="table table-lg">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
                                                <th>Contoh</th>
                                                    ...
                                                    <div class="col-md-12" style="margin-top: 10px;">
                                                        <fieldset>
                                                            <div class="form-group">
                                                                ...
                                                                <input name="contoh" type="text" class="form-control"
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#btn-edit', function()
        {
            ...
            $.get(url, function(data){
                            ...
                            <div class="col-md-12" style="margin-top: 10px;">
                                <fieldset>
                                    <div class="form-group">
                                        <label for="">Contoh</label>
                                        <input name="contoh" type="text" class="form-control"
                                            id="" value="`+ data.contoh +`" placeholder="Input Here">
                                    </div>
                                </fieldset>
                            </div>
                        </div>
                ...
                $('#form-edit').attr('action',`{{route('contoh.update')}}`);
            });
        });
